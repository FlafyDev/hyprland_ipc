...
import 'package:hyprland_ipc/src/socket/commands/info.dart';
...
//         String,
//         String,
//       )> runRawr(HyprlandIPC hyprlandIPC) async {
...
void main() async {
  ...
  // await hyprlandIPC.runCommand(ToggleFullscreenActiveWindowCommand(FullscreenMode.full));
  // GetVersionCommand()

  // print(result2.output[0] as HyprlandVersion);
  // print(result2.output[1] as HyprlandVersion);
